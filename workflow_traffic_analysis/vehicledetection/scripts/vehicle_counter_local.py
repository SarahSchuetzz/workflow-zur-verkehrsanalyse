#Skript zur Objektdetektion in Bilder von lokalem Ordner
#Anpassung bei den mit <--- gekennzeichneten Zeilen


# Copyright: TechVidvan Vehicle counting and Classification
...
for file in os.listdir(working_directory+""): #                                        <------------------------------------
    ...
    if (img_name.endswith('.jpg') or img_name.endswith('.png')):
        img_fn=working_directory+""+ img_name  #                                       <------------------------------------
        #pic to analyse
        image_file =img_fn
        ...
        def from_static_image(image):
            ...
            result_file=working_directory+""+img_name.replace('.','_result.')               #<------------------------------------
