#Skript zum Durchführen der Objektdetektion in den Testbildern im Ordner test/images
...
Observjson="""{
    "Observations":[
        """
l=0
for file in os.listdir(working_directory+"//test//images"):
...
for file in os.listdir(working_directory+"//test//images"):
    img_name=os.fsdecode(file)
    if (img_name.endswith('.jpg') or img_name.endswith('.png')):
        img_fn=working_directory+"//test//images//"+ img_name
        image_file =img_fn

        #pic to analyse
        #img_fn=working_directory+"\\test\\"+'regen.jpg'
        ...
        def from_static_image(image):
            ...
            result_file=working_directory+"//test//results//"+ img_name.replace('.','_result.')
...
open("./test/Observations_example.json","w").write(Observjson)
