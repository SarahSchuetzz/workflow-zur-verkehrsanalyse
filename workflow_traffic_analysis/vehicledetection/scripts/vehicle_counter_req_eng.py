#Skript zur Objektdetektion von 3 Kameras in England + Post auf FROST-Server
#Alternative zu Mainz zur Demonstration
...
while True:
    ...
    def from_static_image(image):
        ...
        #ilos
        global name
        url1 ="http://localhost:8080/FROST-Server/v1.0/Datastreams?$filter=endswith(name,'"+name+"')"
        res1=requests.get(url1).json()
        iotdatastr1= str(res1['value'][0]['@iot.id'])

        countmax=sumofvehicles
    ...
    if __name__ == '__main__':
        ...
        url=['https://uktraffic.live/wp-content/uploads/webcams/52010.jpg?v=1655978882',
            'https://uktraffic.live/wp-content/uploads/webcams/52022.jpg?v=1655989002',
            'https://uktraffic.live/wp-content/uploads/webcams/50685.jpg?v=1655981502']

        for n in range(len(names)):
            now = datetime.now()
            current_time=now.strftime("%d%m%y_%H%M%S")
            name=names[n]
            img_dir=working_directory+"\\england\\"+name+"\\"+current_time
