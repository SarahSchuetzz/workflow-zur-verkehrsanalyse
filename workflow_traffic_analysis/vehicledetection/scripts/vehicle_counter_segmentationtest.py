#Skript zur Objektdetektion in zuvor erzeugten Segmenten (areaofinterest_analysis.py)
...
for file in os.listdir(working_directory+"//test_cv//results"):
    img_name=os.fsdecode(file)
    if (img_name.endswith('.jpg') or img_name.endswith('.png')):
        img_fn=working_directory+"//test_cv//results//"+ img_name
        image_file =img_fn

        #pic to analyse
        #img_fn=working_directory+"\\data\\"+'regen.jpg'
        ...
        def from_static_image(image):
            ...
            result_file=working_directory+"//test_cv//results//objdetect//"+ img_name.replace('.','_result.')
